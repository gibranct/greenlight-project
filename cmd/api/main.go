...
import (
	...
	"github.com.br/gibranct/greenlight/internal/mailer"
	_ "github.com/lib/pq"
)
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://greenlight:greenlight@localhost:5435/greenlight?sslmode=disable", "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "sender", "SMTP sender")
